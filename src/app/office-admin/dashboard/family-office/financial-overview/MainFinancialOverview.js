...
import { useGetOfficeAdminFinancialOverviewQuery } from "@/states/services/office-admin/rootCompanyServices";

function MainFinancialOverview() {
  const { data, isFetching } = useGetOfficeAdminFinancialOverviewQuery();
  console.log("-=-=>>>", data);
