...
export function AddNewRealEstates({ type = "" }) {
  ...
  const { data: tenantData, isFetching: isTenantFetching } = useGetTenantsQuery(
    companyIdByField ? { companyId: companyIdByField } : undefined,
    {
      skip: companyIdByField ? false : true,
    }
  );
                  ...
                  <div className="w-full">
                    ...
                    {type === "Owner" ? (
                      <CompaniesDropDown
                        ...
                        control={control}
                        data={
                          ownerCompaniesFetching ? [] : ownerCompanies?.data
                        }
                        isFetching={ownerCompaniesFetching}
                      />
                    ) : (
                      <CompaniesDropDown
                        name="company_id"
