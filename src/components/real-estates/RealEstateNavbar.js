...
import { RealEstateDropdown } from "./RealEstateDropdown";

function RealEstateNavbar() {
            ...
            {isUserLoggedIn && (
              <div className="flex items-center justify-center gap-3">
                <div className="hidden md:flex md:flex-col">
                  <p className="text-gray-500 text-xs font-semibold text-right capitalize">
                    {userData?.role === "owner"
                      ? "Company Owner"
                      : userData?.role === "officeadmin"
                      ? "Office Admin"
                      : userData?.role}
                  </p>
